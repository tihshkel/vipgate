...
import meetIcon1 from '../../assets/meet/Pic1.svg'
import meetIcon2 from '../../assets/meet/Pic2.svg'
import meetIcon3 from '../../assets/meet/Pic3.svg'
...
import meetPhoto from '../../../meetjpg.jpg'
...
const AirportCard = ({ image, price, name, location, code }) => (
  <div className="flex-shrink-0 w-[280px] sm:w-[320px] cursor-pointer transition-transform hover:scale-[1.02] active:scale-[0.98] snap-start">
    <div className="w-full aspect-[4/3] overflow-hidden rounded-[6px] mb-3">
      ...
      <img src={image || meetPhoto} alt={name} className="w-full h-full object-cover" />
    </div>
  ...
  const steps = [
    {
      icon: meetIcon1,
      title: 'Встреча',
      description: 'Персональный ассистент встречает вас в аэропорту, помогает с багажом и проводит по оптимальному маршруту через терминал.'
    },
    {
      icon: meetIcon2,
      title: 'Проход формальностей',
      description: 'Помощь в прохождении регистрации, паспортного контроля, безопасности и таможни. Экономия времени и отсутствие стресса.'
    },
    {
      icon: meetIcon3,
      title: 'Комфортный финал',
      description: 'Ассистент отслеживает статус рейса, передаёт вас экипажу или встречающим, обеспечивая комфорт до самого конца.'
    }
  ]
    ...
    <div className="bg-white font-sans">
      ...
      <section className="container mx-auto px-4 md:px-8 py-8 md:py-16">
        <div className="flex flex-col-reverse md:flex-row items-center gap-8 md:gap-12">
          <div className="flex-1 space-y-6">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-vip-blue">Meet & assist</h1>
            <p className="font-semibold leading-relaxed max-w-xl" style={{ fontSize: '16px', color: '#809DCA' }}>
              Персональный ассистент встретит вас в аэропорту, поможет с багажом, проведёт через все формальности, трансферы и лаунжи. Вам останется только наслаждаться путешествием.
            </p>
          ...
          <div className="flex-1 w-full relative">
            <div className="relative rounded-[6px] overflow-hidden shadow-none aspect-[4/3] bg-gray-100">
               <img src={meetPhoto} alt="Meet & assist" className="w-full h-full object-cover" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 md:px-8 py-8">
        ...
        <p className="text-gray-600 text-sm leading-relaxed">
          Meet & assist — это премиальная услуга персонального сопровождения в аэропорту, которая обеспечивает максимальный комфорт и спокойствие на всех этапах вашего путешествия. Персональный ассистент встречает вас в аэропорту, помогает с багажом, проводит через регистрацию, паспортный контроль, безопасность и таможню, организует трансферы и доступ в VIP-лаунжи. Вы получаете полное сопровождение от момента прибытия в аэропорт до посадки на рейс или встречи с принимающей стороной. Услуга подходит для деловых поездок, семейных путешествий, людей с ограниченными возможностями и всех, кто ценит комфорт и экономию времени. Meet & assist гарантирует безопасность, пунктуальность и индивидуальный подход на всех этапах.
        </p>
      </section>
